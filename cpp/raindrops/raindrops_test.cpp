...
TEST_CASE("one_yields_itself") { REQUIRE("1" == raindrops::convert(1)); }

// #if defined(EXERCISM_RUN_ALL_TESTS)
TEST_CASE("three_yields_pling") { REQUIRE("Pling" == raindrops::convert(3)); }

TEST_CASE("five_yields_plang") { REQUIRE("Plang" == raindrops::convert(5)); }

TEST_CASE("seven_yields_plong") { REQUIRE("Plong" == raindrops::convert(7)); }

TEST_CASE("six_yields_pling") { REQUIRE("Pling" == raindrops::convert(6)); }

TEST_CASE("nine_yields_pling") { REQUIRE("Pling" == raindrops::convert(9)); }

TEST_CASE("ten_yields_plang") { REQUIRE("Plang" == raindrops::convert(10)); }
